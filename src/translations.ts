...
export const TRANSLATIONS: Translations = {
    'zh-TW': {
        ...
        'show_tasks_mode_desc': '顯示任務模式，需安裝Tasks Plugin',
        'task_filter': '任務分類',
        'uncompleted': '未完成',
        'completed': '已完成',
    ...
    'en': {
        ...
        'show_tasks_mode_desc': 'Show tasks mode, requires Tasks Plugin',
    ...
    'zh': {
        ...
        'show_tasks_mode_desc': '显示任务模式，需要安装Tasks Plugin',
        'task_filter': '任务分类',
        'uncompleted': '未完成',
        'completed': '已完成',
    ...
    'ja': {
        ...
        'show_tasks_mode_desc': 'タスクモードを表示する、Tasks Pluginが必要',
        'task_filter': 'タスクフィルタ',
        'uncompleted': '未完了',
        'completed': '完了',
    ...
    'ru': {
        ...
        'show_tasks_mode_desc': 'Показ режима задач требует установки плагина Tasks Plugin',
    ...
    'uk': {
        ...
        'show_tasks_mode_desc': 'Для відображення режиму завдань потрібно встановити плагін Tasks Plugin',
