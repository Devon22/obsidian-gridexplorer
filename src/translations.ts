...
export const TRANSLATIONS: Translations = {
    'zh-TW': {
        ...
        'show_code_blocks_in_summary': '摘要中顯示CodeBlock',
        'show_code_blocks_in_summary_desc': '設定是否在摘要中顯示CodeBlock的內容',
    ...
    'uk': {
        ...
        'grid_item_height_desc': 'Встановіть висоту елементів сітки (0 для автоматичного налаштування)',
        ...
        'color_pink': 'Рожевий',
        'confirm': 'Підтвердити',
        'note_color_settings': 'Налаштування кольору нотатки',
        'note_color': 'Колір нотатки',
        'note_color_desc': 'Встановіть колір відображення для цієї нотатки',
        'set_note_color': 'Встановити колір нотатки',
